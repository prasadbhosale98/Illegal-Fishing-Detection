...
app.title = 'Iellgal Fishing Detection  '
server = app.server
...
pred = pd.read_csv("D:/illegalfishing/dashboard/data/predictions_rl_v1.csv")
pred['mmsi'] = '[protected]'
        ...
        html.Div(
            children=[
                html.Div(
                    ...
                    children=[
                        html.H1("Catching Fishing Activitis"),
                    ],
                ),
                html.Div(
                                    ...
                                    html.Div(
                                        ...
                                        children=[
                                            html.Div(
                                                ...
                                                children=['Click a vessel to view its activies:']
                                            ),
                                            html.Div(
                            ...
                            dcc.Tab(
                                ...
                                children=[
                                    html.Div(
                                        className="div-banner",
                                        children=[
                                            html.Div(className="div-banner-box", children=['List of vessel  in April, 2021.']),
                                        ]
                                    ),
                                    dcc.Graph(
                                        id="map-prediction",
